			...
			<div class="alert alert-danger">
				<div class="panel panel-green">
					<div class="panel-heading">
						<h3 class="panel-title" style="text-align:left">Select Student</h3>
					...
					<div class="panel-body">
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="panel panel-yellow">
								<div class="panel-heading">
									<h3 class="panel-title text-center">Trainee Information</h3>
								</div>
								<div class="panel-body">
									<table class="table table-bordered table-hover table-striped">
										<tbody>
											...
											<tr class="warning">
												<td>Course</td>
												<td><select multiple="" class="form-control" id="course" name="course[]"
														value="" required>
														<?php
											...
											<tr class="danger">
												<td>doj</td>
												<td><input type="date" id="doj" class="form-control" />
												</td>
											</tr>
											<tr class="success">
												<td>Total Fees</td>
												<td><input type="text" id="fees" class="form-control" />
												</td>
											</tr>
											<!-- <tr class="success">
												<td>Initial Amount</td>
												<td><input type="text" id="initialAmt" class="form-control" />
												</td>
											</tr> -->
											<tr class="success">
												<td>No. of dues</td>
												<td><input type="text" id="nodues" class="form-control"
														onchange="generateDueFields()" /></td>
											</tr>
											<tr class="success" id="dueFieldsRow">
												<td colspan="2">
													<table id="duesTable"
														class="table table table-bordered table-hover table-striped">
														<thead id="duesTableHeader" style="display: none;"
															class="btn-info">
											...
											<tr class="warning">
												...
												<td>
													<label class="radio-inline">
														<input type="radio" name="ge" id="gender1" value="male"
															checked="">male
													</label>
													<label class="radio-inline">
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h3 class="panel-title text-center">Last Payment Detail</h3>
								</div>
								<div class="panel-body">
						...
						<!-- <div class="col-lg-4 col-md-12 col-sm-12">
							<div class="panel panel-green">
								<div class="panel-heading">
									<h3 class="panel-title text-center">New Payment</h3>
								</div>
								<div class="panel-body">
									<div class="form-group">
										<label>Date</label>
									...
									<div class="form-group">
										...
										<label class="checkbox-inline">
											<input type="radio" name="payment_type" value="initial" id="initial_payment"
												onchange="validateamt()"> Initial
										</label>
										<label class="checkbox-inline">
											<input type="radio" name="payment_type" value="due" id="due_payment"
												onchange="validateamt()"> Due
										</label>
									</div>
									<div class="form-group pendingPayDiv hidden">
										<label>Pay Date</label>
										<input type="date" class="form-control" name="pay_date"
											id="pending_payment_date" required>
									</div>
									<div class="panel-heading text-center ">
										<button type="submit" class="btn btn-success paybutton" name="submit"
